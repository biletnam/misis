...
begin
  ...
  begin
    ...
    Label3.Caption := 'Клиентов в кафе: '+IntToStr((SceneMan.SellerMan.Sellers[0] as TSeller).ClientList.Count +
    ...
    Label5.Caption := 'Свободно мест: '+IntToStr(SceneMan.Table.Places - SceneMan.Table.Clients.Count);
