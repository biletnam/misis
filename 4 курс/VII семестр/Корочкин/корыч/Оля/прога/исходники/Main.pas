...
begin
  //test2 := TTimeControls.Create('Станок1',Form2.GroupBox1);
...
begin
  ...
  begin
   Label2.Caption := 'Сделано изделий 1-го типа: '+ IntToStr(((test.ConvList[0] as TConv).Stans.Last as TStan).DoneNum);
   Label3.Caption := 'Сделано изделий 2-го типа: '+ IntToStr(((test.ConvList[1] as TConv).Stans.Last as TStan).DoneNum);
   Label4.Caption := 'Сделано изделий 3-го типа: '+ IntToStr(((test.ConvList[2] as TConv).Stans.Last as TStan).DoneNum);
  end;
