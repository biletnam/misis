...
procedure main; {градиентный, наискорейшего спуска}
begin
   textbackground(1);
   ...
   writeln('Нахождение оптимума по методу наискорейшего спуска');
   {--Получение имени файла для ввода результатов--}
   GetInputName(fil);

   {--Выбор функции--}
   {v_fun(n1,n);
   writeln(fil,'  Число переменных = ',n);
   writeln('    Число переменных = ',n);
...
procedure print;     { вывод массива записей на экран }
 ...
 begin
   clrscr;
   mas[1].y:=14; mas[1].s:='1) Метод "Наискорейшего спуска"';
   ...
   while true do
      begin
         ...
         begin
            ...
            Write(' ');
            textattr:=28;
            write('ТЕМА: Метод "Наискорейшего спуска" ');
            textattr:=26;
            write('');
            Write('');
            Writeln;
